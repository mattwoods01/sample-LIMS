...
class MaintenanceEventCreator:
    ...
    def format_dataframes(self):
        """
        format dataframe and merge based off name
        """
        ...
        return pd.merge(instruments_with_type_df, instruments_df, on='Name', how='inner')

    def update_maintenances(self, item):
        """
        send api route to labguru to update maintenence events
        """
        try:
